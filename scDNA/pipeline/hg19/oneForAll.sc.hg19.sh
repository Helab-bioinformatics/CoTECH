...
bowtie2 -p 6 -5 42 -3 21 --dovetail --very-sensitive-local --no-unal --no-mixed --no-discordant -X 2000 -x /media/helab/data1/00_public/database/genomes/hg19_bowtie2/hg19 -1 ./00_raw_data/${base}.1.fq.gz -2 ./00_raw_data/${base}.2.fq.gz -S ./02_alignment/${base}.sam 2> ./02_alignment/${base}.align.log 
done 
#mm10
#for i in `ls *.1.fq.gz`; 
#do base=$(basename $i ".1.fq.gz"); 
